        ...
        default: /* el resto de instrucciones */
            ...
            switch (solucion_riesgos_datos) {
                ...
                case cortocircuito:
                    ...
                    /* WBtoEX */
                    //Insertar cp si és un load i hi ha dependencia
                    if (es_load(ID_EX.IR) &&
