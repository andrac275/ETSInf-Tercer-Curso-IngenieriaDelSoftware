...
int main(int argc, char *argv[])
{
   ...
   * and send the initial x to all */
   //Andreu: Difondrer la matriu a tots els procesos:
  ...
  if (me == 0) {
    ...
    //Andreu: Estes linies son les que hi havia al principi
  ...
  //Andreu: Estes dos linies equivalen a la (150+155) i la (151+156)
  ...
  for (iter = 1; iter <= num_iter; iter++) {
     ...
     * and replicate it in all the processes */
     ...
     //Andreu: Les següents linies son del codi base
    // if (me == 0) {
...
#define ABS(a) ((a) >= 0 ? (a) : -(a))
  ...
  //Andreu: Les seguents linies son del codi base.
  // if (me == 0) {
  //   for (proc = 1; proc < num_procs; proc++) {
  ...
  if (me == 0) {
    norma = aux; //Andreu: Copiar aux a norma si eres el proces 0.
