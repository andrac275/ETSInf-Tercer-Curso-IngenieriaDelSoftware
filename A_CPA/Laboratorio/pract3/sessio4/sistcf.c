/*ANDREU: Este es el que he modificat*/
#include <math.h>
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
int main(int argc, char *argv[])
{
  ...
  double dError;
  double temps_Ini,temps_Fi,temps;  //Andreu:Comprobar temps
  ...
  //Andreu: La 'mb' es la k perque es n / p.
  mb = n / p;
  if (n % p != 0) mb++;
  ...
  temps_Ini =MPI_Wtime(); //Andreu: Iniciar temps medir programa

  /* STEP 2: Distribute data (A, b) */
  MPI_Bcast(b, n, MPI_DOUBLE, 0, MPI_COMM_WORLD);
  //Les seguents dos linies es lo original.
