...
namespace TarongISWPesistenceTest
{
    ...
    public class TruckTest: BaseTest
    {
        ...
        {   /*Arrange
            ...
            // maximumWeight de truck l'hem llevat, ja que no ho implementem amb un constructor
            Assert.AreEqual(TestData.EXPECTED_MAXIMUN_WEIGHT, "TareWeight not properly initialized. Please check whether you have correctly assigned the parameters in the corresponding class.");
